...
#define AMD_PWR_ALL_PIDS 0xFFFFFFFFU
    ...
    #define AMD_PWR_MAX_CORES_SUPPORTED     CPU_SETSIZE
#else
    #define AMD_PWR_MAX_CORES_SUPPORTED     1024
#endif

#define AMD_PWR_CORE_MASK_SIZE (AMD_PWR_MAX_CORES_SUPPORTED / 64)
...
typedef struct AMDTPwrDevice
{
    ...
    char*               m_pName = nullptr;          /**< Name of the device */
    char*               m_pDescription = nullptr;   /**< Description about the device */
    bool                m_isAccessible;   /**< If counters are accessible */
    AMDTUInt32          m_categoryMask;   /**< Supported counter category by the device */
    AMDTPwrDevice*      m_pFirstChild = nullptr;    /**< Points to the sub-devices of this device */
    AMDTPwrDevice*      m_pNextDevice = nullptr;    /**< Points to the next device at the same hierarchy */
} AMDTPwrDevice;
